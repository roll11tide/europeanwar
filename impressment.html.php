...
<body>
    ...
    <header class="intro-header" style="background-image: url('img/impressment.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        <h1>Impressment of American sailors</h1>
                        <h2 class="subheading">How the British fueled their navy</h2>
                        <span class="meta">Content created by Joseph Northington and Alex Johnson</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <p><i>Content created by Joseph Northington and Alex Johnson.</i></p>
                </div>
            </div>
        </div>
    </article>
